              ...
              <div *ngFor="let bitacora of group.bitacoras; let i = index" class="timeline-entry"
                ...
                <div class="timeline-content">
                  <div class="timeline-header">
                    <div class="timeline-category" [attr.data-category]="bitacora.categoria">
                      {{ getCategoriaName(bitacora.categoria) }}
                    </div>
                    <div class="timeline-date-small">{{ bitacora.fecha | date:'mediumDate' }}</div>
                  </div>
                  ...
                  <p *ngIf="bitacora.descripcion" class="timeline-description">
                    {{ truncateText(bitacora.descripcion, 150) }}
                  </p>

                  <div class="timeline-image" *ngIf="bitacora.imagenUrl">
                    <a [routerLink]="['/bitacoras', bitacora.id]">
                      <img [src]="getImageUrl(bitacora.imagenUrl)" [alt]="bitacora.titulo">
                    </a>
                  </div>
