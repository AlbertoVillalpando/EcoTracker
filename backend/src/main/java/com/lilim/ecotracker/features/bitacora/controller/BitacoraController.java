...
import com.lilim.ecotracker.features.bitacora.service.BitacoraService;
...
public class BitacoraController {
    ...
    public ResponseEntity<List<BitacoraDTO>> getAllBitacoras(
        ...
        if (categoria != null && !categoria.isEmpty()) {
            bitacoras = bitacoraService.getBitacorasByCategoria(categoria);
        } else {
    ...
    public ResponseEntity<?> createBitacora(
        ...
        try {
            ...
            BitacoraDTO created = bitacoraService.createBitacora(dto, imagen);
    ...
    public ResponseEntity<?> updateBitacora(
        ...
        try {
            ...
            BitacoraDTO updated = bitacoraService.updateBitacora(id, dto, imagen);
    ...
    public ResponseEntity<?> deleteBitacora(@PathVariable Long id) {
        try {
            boolean deleted = bitacoraService.deleteBitacora(id);
            if (deleted) {
    ...
    public ResponseEntity<Map<String, String>> getCategorias() {
        return ResponseEntity.ok(bitacoraService.getCategorias());
    }
}